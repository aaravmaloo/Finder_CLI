...
HOME_DIR = Path.home()  # Gets C:\Users\Aarav Maloo automatically
EXCLUDED_FOLDERS = {"AppData"}  # AppData is restricted, so exclude it

def index_folder(folder_path):
    """ Scan a folder and return its files and subdirectories """
    try:
        ...
        for f in path.iterdir():
            try:
                ...
                print(f"Skipping (no permission): {f}")
        ...
        print(f"Skipping (no permission): {folder_path}")
...
def index_home_directory():
    """ Scan only the home directory (C:\Users\Aarav Maloo) """
